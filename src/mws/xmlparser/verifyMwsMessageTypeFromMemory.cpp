...
*/
/**
  * @brief File containing the implementation of the verifyMwsMessageTypeFromMemory
  * function
  *
  * @file verifyMwsMessageTypeFromMemory.cpp
...
string
verifyMwsMessageTypeFromMemory(char* mem)
{
#ifdef TRACE_FUNC_CALLS
    LOG_TRACE_IN;
#endif
